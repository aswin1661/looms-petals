      ...
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.column}>
            <h3 className={styles.brandName}>Looms & Petals</h3>
            <p className={styles.tagline}>
              Elegance woven with tradition, styled for today
            </p>
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.linkList}>
              ...
              <li><a href="#" className={styles.link}>Jewelry</a></li>
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.linkList}>
              ...
              <li><a href="#" className={styles.link}>Return Policy</a></li>
